  ...
  constructor() {
    try {
      ...
      if (electronProcess.resourcesPath) {
        ...
        // Development: relative path from compiled location (out/dist/platforms/windows/)
        modulePath = path.join(__dirname, '../../../../native/windows/build/Release/event_monitor.node');
      }
